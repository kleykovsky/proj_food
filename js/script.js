	...
	function getDynamicInformation(selector) {
		...
		input.addEventListener('input', () => {
			...
			if (input.value.match(/\D/g)) {
				...
				input.style.cssText = 'border: 1px solid red; font-size: ' +
										'20px; color: red; transition: 0.5s all;';
			} else {
				input.style.cssText = 'border: none; font-size: ' +
					'18px; color: black; transition: 0.5s all;';
			}
